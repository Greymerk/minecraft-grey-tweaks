...
public enum Treasure {
	...
	public static void generate(IWorldEditor editor, RandomSource rand, Coord pos, Treasure type) {
		Treasure.generate(editor, rand, pos, type, ChestType.CHEST);
	}
	
	public static void generate(IWorldEditor editor, RandomSource rand, Coord pos, Cardinal dir, Treasure type) {
		Treasure.generate(editor, rand, pos, dir, type, ChestType.CHEST);
	}
	
	public static void generate(IWorldEditor editor, RandomSource rand, Coord pos, Treasure type, ChestType block){
		try {
	...
	public static void generate(IWorldEditor editor, RandomSource rand, Coord pos, Cardinal dir, Treasure type, ChestType block){
		try {
			ITreasureChest chest = new TreasureChest(type);
