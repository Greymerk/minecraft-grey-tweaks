...
public class ItemTool extends ItemBase {
	...
	public static ItemStack getTool(RegistryAccess reg, FeatureFlagSet features, RandomSource rand, Difficulty diff, Quality quality, Equipment type, boolean enchant){		
