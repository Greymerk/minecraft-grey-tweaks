...
public class GameRuleTweaks {
	...
	public static final GameRule<Boolean> GREY_TWEAK_ALLOW_ELYTRA = GameRuleBuilder.forBoolean(false).buildAndRegister(Identifier.fromNamespaceAndPath(GreyTweaks.MOD_ID, id)); 
